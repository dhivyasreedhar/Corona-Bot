...
# Information: Total cases, total recovered, total deaths, recoveries - Headlines need advanced web scraping [Include later]
# Audio responses - Done
# Choice for male / female voice - Done
# Set up error handling in gender selection - Done
# Mental health support - Done
# Include wider support for negative and positive responses - Done
# Include preliminary slang support - Done
# Include exception handling for personal questions - Done
...
corona = ['chinese virus', 'covid 19', 'china virus', 'corona', 'virus', 'corona virus', 'covid', 'wuhan virus', 'pandemic']
...
positive = ['yes', 'yeah', 'yo', 'indeed', 'sure', 'yup', 'fosure', 'yea', 'ya']
personal = ['you', 'yours', 'your']
mentalHealth = ['sad', 'anxious', 'fear', 'scared', 'hopeless', 'useless', 'bad', 'worse', 'worst', 'worried', 'depression', 'breakdown', 'clueless', 'unproductive']
...
while(True):
    ...
    if personalBool:
        ...
        if (negat):
            ...
            driver = webdriver.Chrome("C:\\Users\\Lenovo\\OneDrive\\Desktop\\infobot\\chromedriver.exe")
